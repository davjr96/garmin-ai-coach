...
class ModelSelector:
    ...
    CONFIGURATIONS: dict[str, ModelConfiguration] = {
        ...
        "gpt-5.2": ModelConfiguration(name="gpt-5.2", base_url="https://api.openai.com/v1"),
    ...
    def get_llm(cls, role: AgentRole):
        ...
        model_configs = {
            ...
            "gpt-5.2": {
                ...
                "reasoning": {"effort": "high"},
                "model_kwargs": {"text": {"verbosity": "medium"}},
                "log": "Using GPT-5.2 with Responses API for {role} (verbosity: medium, reasoning_effort: high)",
            },
            "gpt-5-mini": {
                "use_responses_api": True,
                "reasoning": {"effort": "high"},
